...
export default function DashboardError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center animate-fade-in">
      ...
      <div>
        <h2 className="text-base font-semibold" style={{ color: "#C5CBE8" }}>Page failed to load</h2>
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/dashboard/admin" className="rounded-xl px-4 py-2 text-sm font-medium" style={{ background: "rgba(144,141,206,0.10)", color: "rgba(197,203,232,0.70)", border: "1px solid rgba(144,141,206,0.20)" }}>
          Go to Dashboard
        </Link>
      </div>
    </div>
